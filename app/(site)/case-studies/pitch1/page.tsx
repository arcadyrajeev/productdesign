...
export default function RupeeFlowPitchCaseStudy() {
  ...
  return (
    <main className="bg-neutral-50 pt-12 text-neutral-900 heading">
      {/* HERO */}
      <section className="max-w-6xl mx-auto px-30 pt-24 pb-20">
        ...
        {/* COVER IMAGE */}
        <div className="mt-16 px-30 relative aspect-[16/9] w-full overflow-hidden rounded-lg border border-neutral-200 bg-white">
          <Image
      ...
      {/* CONTEXT */}
      <section className="max-w-6xl mx-auto px-30 py-8 border-t border-neutral-200">
      ...
      {/* REAL PROBLEM */}
      <section className="max-w-6xl mx-auto px-30 py-20 border-t border-neutral-200">
      ...
      {/* MARKET & ASSUMPTIONS */}
      <section className="max-w-6xl mx-auto px-30 py-4 border-t border-neutral-200">
      ...
      {/* OUTCOME */}
      <section className="max-w-6xl mx-auto px-30 py-10 border-t border-neutral-200">
      ...
      {/* FOOTER CTA */}
      <footer className="max-w-6xl mx-auto px-30 py-16 border-t border-neutral-200">
